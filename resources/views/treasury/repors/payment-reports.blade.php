                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group" role="group">
                                ...
                                <button type="button" class="btn btn-outline-dark btn-rounded" data-mdb-toggle="modal"sdata-mdb-target="#statusModal">Status</button>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <div class="btn-group" role="group">
                                <button type="button" class="btn btn-outline-dark btn-rounded">PDF</button>
                                <button type="button" class="btn btn-outline-dark btn-rounded" data-mdb-toggle="modal"data-mdb-target="#statusModal">Status</button>
                        </div></td>
                    </tr>
                </tbody>
            </table>
