...
<body>
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                <button class="btn btn-outline-dark btn-rounded" data-mdb-target="#registerModal" data-mdb-toggle="modal" data-mdb-dismiss="modal">Register</button>
    ...
    <div class="modal fade" id="registerModal" aria-hidden="true" aria-labelledby="registerModalToggleLabel22" tabindex="-1">
