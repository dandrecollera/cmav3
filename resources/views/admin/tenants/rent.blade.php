...
<div class="d-flex justify-content-end p-3">
    <button type="button" class="btn btn-outline-dark btn-rounded" data-mdb-toggle="modal" data-mdb-target="#selectModal">
        Select Tenant
    </button>
            ...
            <div class="row justify-content-center">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mb-3 row form-outline">
            ...
            <div class="row justify-content-center">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="text-center col-12 mb-3 md-2 mt-2 mx-4">
