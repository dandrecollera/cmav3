    ...
    <div class="sidebar">
        ...
        <ul class="nav-links">
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li><a class ="link_name"href="#">Floors</a></li>
                    <li><a href="/floor-add">Add</a></li>
                    <li><a href="/floor-view">View</a></li>
                </ul>
            </li>
            ...
            <li>
                <div class="icon-link">
                    <a href="#">
                        ...
                        <span class="link_name">Stalls</span>
                    </a>
                    <i class='bx bx-chevron-down arrow' ></i>
                </div>
                <ul class="sub-menu">
                    <li><a class ="link_name"href="#">Stalls</a></li>
                    <li><a href="/stalls-add">Add</a></li>
                    <li><a href="/stalls-view">View</a></li>
                </ul>
            </li>
            ...
            <li>
                ...
                <ul class="sub-menu blank">
                    <li><a class ="link_name"href="/lostandfound">Lost and Found</a></li>
                </ul>
            </li>
