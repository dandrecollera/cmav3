...
<body>
    <div class="sidebar">
        ...
        <ul class="nav-links">
            <li>
                <a href="/treasury-dashboard">
                    <i class='bx bx-grid-alt' ></i>
                    <span class="link_name">Dashboard</span>
                </a>
                <ul class="sub-menu blank">
                    <li><a class ="link_name"href="/treasury-dashboard">Dashboard</a></li>
                </ul>
            </li>
            ...
            <li>
                <a href="/treasury-account-settings">
                    <i class='bx bx-user'></i>
                    <span class="link_name">Account Settings</span>
                </a>
                <ul class="sub-menu blank">
                    <li><a class ="link_name"href="/treasury-account-settings">Account Settings</a></li>
                </ul>
            </li>
        ...
        <div class="profile-details">
            ...
            <div class="name">
                <div class="profile-name">Treasury</div>
            </div>
