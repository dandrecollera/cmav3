            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="text-center mt-5">
                        <img src="/img/cma-admin1.png" class="img-fluid custom-image"
                            alt="Office of City Mall of Antipolo">
                        <p class="font-weight-bold mt-3">Go to the office of City Mall of Antipolo located at the third
                            floor of the Market.</p>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control is-valid" id="middlename" name="middlename"
                                ...
                                <div class="mb-3 form-outline">
                                    <textarea class="form-control is-valid" id="address" name="address" required
                                        rows="2"></textarea>
                                    <label class="form-label" for="typeText">Address</label>
                                </div>

                                <div class="mb-3 form-outline">
                                    <input class="form-control is-valid" type="date" id="birthday" name="birthday"
                                        required />
                                ...
                                <div class="mb-3 form-outline">
                                    <input id="contactno" name="contactno" class="form-control is-valid"
                                        data-mdb-showcounter="true" maxlength="11" required />
